...
std::string name = "kfleko565"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
std::string ownerid = "V3774KxKUg"; // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
std::string secret = "9b35255b7c061e541e09b3cd1a24b592c07e5fef9defe1e3382f897f2fa4046b"; // app secret, the blurred text on licenses tab and other tabs
